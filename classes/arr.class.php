...
class Arr extends \ArrayIterator
{
	 ...
	 *     $value = static::path($array, 'foo.bar');
	 *
	 * Using a wildcard "*" will search intermediate arrays and return an array.
	 *
	 *     // Get the values of "color" in theme
	 *     $colors = static::path($array, 'theme.*.color');
	 *
	 *     // Using an array of keys
	 *     $colors = static::path($array, array('theme', '*', 'color'));
	 *
	...
	*/
	 ...
	 *     $username = static::get($_POST, 'username');
	 *
	 *     // Get the value "sorting" from $_GET, if it exists
	 *     $sorting = static::get($_GET, 'sorting');
	 *
	 ...
	 *     $auth = static::extract($_POST, array('username', 'password'));
	 *
	 ...
	 *     static::unshift($array, 'none', 'Select a value');
	 *
	 ...
	 *     $array = static::map('strip_tags', $array);
	 *
	...
	public static function map($callback, $array)
	{
		foreach ($array as $key => $val)
		{
			if (\is_array($val))
			{
				$array[$key] = static::map($callback, $val);
			}
			else
			{
	 ...
	 *     list($func, $params) = static::callback('Foo::bar(apple,orange)');
	 *
